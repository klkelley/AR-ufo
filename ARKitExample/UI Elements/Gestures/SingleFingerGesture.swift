    ...
    func finishGesture() {
        ...
        for result in results {
            ...
            if object != nil {
                ...
                object?.runAction(SCNAction.repeat(SCNAction.rotateBy(x: 0, y: 1, z: 0, duration: 1), count: 20))
                
                object?.runAction(SCNAction.move(by:SCNVector3(x: 0, y: 2, z: 0), duration: 7))
            }
